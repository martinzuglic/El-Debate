...
<body>
    ...
    <?php   
            ...
            $query = "SELECT * FROM clanak WHERE kategorija='Svijet' LIMIT 5";
            $result = mysqli_query($dbc, $query);
    
            $qslika = "SELECT slika FROM clanak WHERE kategorija='Svijet' LIMIT 5";
    ...
    <?php   
            ...
            $query = "SELECT * FROM clanak WHERE kategorija='Sport' LIMIT 5";
            $result = mysqli_query($dbc, $query);
    
            $qslika = "SELECT slika FROM clanak WHERE kategorija='Sport' LIMIT 5";
            $slikares = mysqli_query($dbc, $qslika);
            $slika = mysqli_fetch_array($slikares);
            $s = $slika['slika'];
